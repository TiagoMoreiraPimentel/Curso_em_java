 ...
 */
package com.mycompany.estacionamento_60vagas;

import java.util.Scanner;

/**
 *
 * - Crie um algoritmo que receba uma quantidade (N) de carros e estacione todos
 * eles - Só é possível estacionar 6 carros por fileira - Você só possui 10
 * fileiras - Será necessário informar o cliente a falta de espaço (ou seja, se
 * você já estacionou todos os carros possíveis)
 *
 * @author Tiago
 */
public class Estacionamento_60vagas {
